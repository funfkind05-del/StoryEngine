...
export const LOREBOOKS: LoreEntry[] = [
  ...
  { id: 'DUN_DEEP_002:1', title: 'After the Crown', text: 'The voice is gone and the thing remains, and a thing that size does not need a voice to WANT. Watch the roots. Wanting travels down roots. — Sella’s working notes, unbound' },
  { id: 'DUN_DEEP_002:2', title: 'Root Survey, Abandoned', text: 'The worked stone grows. Not builds — GROWS, a knuckle a season, downward and outward under every district. We measured for three years and then the measurements started coming back before we took them. — College deep survey' },
  { id: 'DUN_DEEP_002:3', title: 'The Choir’s Hymnal', text: 'It cannot speak, so they sing FOR it, in the pitch it dreams in. Every verse ends on the same held note. The note is a question. The question is addressed to you. — transcription, incomplete by necessity' },
  { id: 'DUN_DEEP_002:4', title: 'The Herald Vacancy', text: 'A crown without a head finds candidates. The seraph auditioned. The lich SUBMITTED A BID. The colossus simply stood where the throne could see it. It has not chosen. It is waiting for a better applicant, and it knows your résumé. — unsigned, recent, dry' },
  { id: 'DUN_DEEP_002:5', title: 'What Roots Drink', text: 'Trees drink water. These drink NOTICE. Every root ends under a place where people gather — the market, the temple, the pit, the tavern hearths — and the stone there is warm, and faintly, horribly content. It is not sieging the city. It is SIPPING it. — deep survey, final entry' },
  { id: 'DUN_DEEP_002:6', title: 'The Terms, Drafted', text: 'Found at the deepest root, on paper no mill made, in a fair clerk\u2019s hand: articles of wardenship, party of the first part left blank. Clause one: TO BE KNOWN. Clause two: TO BE NAMED. Clause three, underlined twice: TO BE VISITED. The blank is sized for more than one name. — the document itself' },
];
