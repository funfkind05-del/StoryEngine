...
export const MONSTER_ART_PROMPTS: Record<string, string> = {
  ...
  'root-wight': 'a desiccated corpse threaded through and lifted like a marionette by pale worked-stone roots that grow through its ribcage and limbs.',
  'chorister-of-want': 'a tall gaunt robed figure with too many open mouths arranged down its throat and chest, all singing, eyes serene and closed.',
  'salt-kraken': 'a colossal kraken crusted entirely in white salt crystal, tentacles cracking the brine crust as they move, one huge eye like a pearl.',
  'unlamped-dark': 'a humanoid silhouette of pure darkness visible only by the ring of dying lamplight bending INTO it, faint frost where it stands.',
  'warden-of-nine-forts': 'an ancient skeletal knight-commander in the fused armor of nine different ruined garrisons, banner-scraps frozen to its pauldrons.',
  'grief-golem': 'a hulking golem built from broken headstones, funeral wreaths, and mourning-veils, weeping rusty water from cracks in its face.',
  'the-auditor': 'a gaunt gilded lich in a clerk\u2019s half-moon spectacles, quill of black iron in hand, ledgers chained to its belt, expression of infinite patience.',
  'tide-empress': 'a regal drowned empress with a coral crown fused to her skull, robes of moving seawater, small drowned sailors visible swimming inside the robes.',
  'ashfather': 'a towering patriarch figure of compacted grey ash holding embers where organs should be, wearing the burned remains of founder\u2019s finery.',
  'hollow-empress': 'an elegant hollow queen whose ornate imperial gown and crown are intact but whose body inside is an absence, a woman-shaped void of dark.',
  'worm-of-the-ring': 'a vast blind dragon-worm coiled in a perfect ring around a buried city, scales of dark stone, mouth ringed with lamplight-colored teeth.',
  'the-forgotten-founder': 'a stately undead founder in three-hundred-year-old statesman\u2019s dress, face blurred and unrememberable, holding a chisel and a struck-out name.',
  'the-first-warden': 'a giant of ancient bronze and hillstone, older than the city, seated on a ruined watchtower like a throne, eyes two watchfires.',
  'the-held-god-dreaming': 'an impossibly vast serene face of dark stone half-emerged from cavern bedrock, eyes closed, roots of worked stone growing from its temples.',
  'the-held-god-waking': 'the same vast dark stone god-face with ONE EYE OPEN, pupil a spiral of lamplight, the cavern cracking around it in radial lines.',
  'candidate-in-borrowed-skin': 'a too-perfect smiling human noble whose skin fits slightly wrong at the neck and wrists, faint root-shadows moving under the skin.',
};
