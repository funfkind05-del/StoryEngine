...
export function buildSeedWorld(): WorldState {
  ...
  const L: GameLocation[] = [
    ...
    loc({ id: 'LOC_LAMPHALL', mapPos: { x: 40, y: 60 }, name: "Lamplighters' Hall", type: 'guildhall', district: 'Ironmarket', parent: 'LOC_IRONMARKET', description: 'Oil, wicks, ladders — and the best rumor exchange in Blackwall, if you carry a lamp or a purse.', atmosphere: 'Every conversation pauses when you enter.', services: ['rumors', 'work'], dangerRating: 2, connections: ['LOC_IRONMARKET_SQ', 'LOC_RATCATCHER'], factionInfluence: { FAC_LAMPLIGHTERS: 8, FAC_WATCH: 3 } }),
    loc({ id: 'LOC_FIGHTPIT', mapPos: { x: 30, y: 70 }, name: 'The Pit of Honest Work', type: 'landmark', district: 'Dock Ward', parent: 'LOC_DOCKWARD', description: 'A drained cistern with rope rails and a bookmaker. Fists for coin, and the crowd remembers a good showing longer than the Watch remembers a warrant.', atmosphere: 'Sweat, chalk, shouted odds.', dangerRating: 6, connections: ['LOC_RATCATCHER', 'LOC_WHARVES'], services: ['fighting', 'wagering'], factionInfluence: { FAC_REDKNIVES: 5, FAC_TIDECOURT: 3 } }),
